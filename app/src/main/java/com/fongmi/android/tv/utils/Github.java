...
public class Github {
    ...
    private static final String GITHUB_LATEST = "https://github.com/xinyi1984/webhtv/releases/latest/download";
    private static final String GITHUB_RELEASE = "https://github.com/xinyi1984/webhtv/releases/download";
    private static final String GITHUB_API = "https://api.github.com/repos/xinyi1984/webhtv/releases/tags";
    private static final String GITHUB_RELEASES_API = "https://api.github.com/repos/xinyi1984/webhtv/releases";
    private static final String GITHUB_RELEASE_ASSETS_API = "https://api.github.com/repos/xinyi1984/webhtv/releases/assets";
    private static final String CNB = "https://cnb.cool/ysysxy/webhtv-release/-/git/raw/main";
